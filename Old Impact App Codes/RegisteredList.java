...
public class RegisteredList extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_registered_list, menu);
		return true;
	}
	...
	public void webPost() {
		...
		try {
			response = CustomHttpClient.executeHttpPost(
					"http://ewb-calpoly.org/androidRegisteredList.php",
					postParameters);
						...
						.setOnItemClickListener(new AdapterView.OnItemClickListener() {
							...
							public void onItemClick(AdapterView<?> parent,
								...
								Intent viewDetails = new Intent(
										RegisteredList.this, EventDetails.class);
								viewDetails.putExtra("eventid", item.getId());
								RegisteredList.this.startActivity(viewDetails);
							}
						});
